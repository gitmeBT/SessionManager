...
contextBridge.exposeInMainWorld('api', {
  ...
  openInFinder: (projectName: string) => ipcRenderer.invoke('open-in-finder', projectName),
  copyProjectPath: (projectName: string) => ipcRenderer.invoke('copy-project-path', projectName),
  openInVscode: (projectName: string) => ipcRenderer.invoke('open-in-vscode', projectName),
  getProjectPath: (projectName: string) => ipcRenderer.invoke('get-project-path', projectName),
